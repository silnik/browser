...
use Silnik\Browser\Model\Browser;
use Silnik\Browser\Model\Engine;
use Silnik\Browser\Model\Os;
use Silnik\Browser\Model\Device;

class Main
{
    /**
     * @var \Silnik\Browser\Model\Browser  $browser      Information about the browser
     */
    public $browser;

    /**
     * @var \Silnik\Browser\Model\Engine   $engine       Information about the rendering engine
     */
    public $engine;

    /**
     * @var \Silnik\Browser\Model\Os       $os           Information about the operating system
     */
    public $os;

    /**
     * @var \Silnik\Browser\Model\Device   $device       Information about the device
     */
    public $device;
