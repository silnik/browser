...
{
    /**
     * @var \Silnik\Browser\Model\Using       $using      Information about web views the browser is using
     * @var \Silnik\Browser\Model\Family      $family     To which browser family does this browser belong
     */
    public $using;
    public $family;
